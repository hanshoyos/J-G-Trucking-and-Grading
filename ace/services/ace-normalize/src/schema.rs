...
///
/// This mirrors the protobuf definition in `proto/ace_cef.proto` but is
/// idiomatic Rust and includes helpers for serialization.  The canonical
/// wire format produced to Kafka is JSON (Phase 1); in Phase 2 we switch
/// to Protobuf binary for ~3× throughput improvement.
